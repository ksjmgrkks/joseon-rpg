...
> - [ ] (선택) 배경 아트 자체(산 능선·안개 디테일) 더 풍부하게 하려면 `tools/pixel/gen_background.py` 개선 후 PC에서 `python tools/pixel/gen_background.py` 재생성 — 이건 PIL 필요(폰 세션 불가).
